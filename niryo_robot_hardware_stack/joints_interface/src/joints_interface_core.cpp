 ...
 */
    JointsInterfaceCore::JointsInterfaceCore(ros::NodeHandle &rootnh,
                                             ...
                                             std::shared_ptr<can_driver::CanInterfaceCore> can_interface) : _joint_controller_name("/niryo_robot_follow_joint_trajectory_controller"),
                                                                                                            ...
                                                                                                            _can_interface(can_interface)
    {
        ...
        _previous_state_learning_mode = _robot->getLearningMode();
 ...
 */
                                                       ...
                                                       niryo_robot_msgs::SetInt::Response &res)
    {
        ...
        {
            if (_robot->getHardwareVersion() == "ned2")
            {
                _previous_state_learning_mode = false;
                _robot->activateLearningMode(false);
            }
            else
            {
