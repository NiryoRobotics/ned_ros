...
public:
    ...
    private:
        ...
        void sendCalibrationOffset(const std::shared_ptr<common::model::StepperMotorState>& pState,
        ...
        void relativeMoveStepperMotor(const std::shared_ptr<common::model::JointState>& pState, int steps, int delay, bool wait);
