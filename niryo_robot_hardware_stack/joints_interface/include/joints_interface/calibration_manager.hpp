...
{
public:
  CalibrationManager(ros::NodeHandle &nh, std::vector<std::shared_ptr<common::model::JointState>> joint_list,
  ...
  int startFactoryCalibration(FactoryCalibration::Request::_command_type command,
