...
namespace DynamixelDriver
{
    struct XL320Reg
    {
        ...
        static constexpr std::uint8_t ADDR_RETURN_LEVEL        = 17;
        static constexpr std::uint8_t SIZE_RETURN_LEVEL        = 1;
        ...
        static constexpr std::uint8_t ADDR_GOAL_SPEED          = 32;
        static constexpr std::uint8_t SIZE_GOAL_SPEED          = 2;
        ...
        static constexpr std::uint8_t ADDR_PRESENT_SPEED       = 39;
        static constexpr std::uint8_t SIZE_PRESENT_SPEED       = 2;
