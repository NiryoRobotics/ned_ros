...
namespace DynamixelDriver {
    ...
    private:
        ...
        static constexpr int XC430_ADDR_D_GAIN              = 80;
        static constexpr int XC430_ADDR_I_GAIN              = 82;
        static constexpr int XC430_ADDR_P_GAIN              = 84;
        static constexpr int XC430_ADDR_FF2_GAIN            = 88;
        static constexpr int XC430_ADDR_FF1_GAIN            = 90;
