...
namespace common {
    namespace model {
        ...
        DxlMotorState::DxlMotorState(uint8_t id, EDxlMotorType type, bool isTool)
        ...
        void DxlMotorState::reset()
        {
            ...
            _type = EDxlMotorType::MOTOR_TYPE_UNKNOWN;
            _isTool = false;
        }
        ...
        {
            return (0 != _id && EDxlMotorType::MOTOR_TYPE_UNKNOWN != _type);
        }
