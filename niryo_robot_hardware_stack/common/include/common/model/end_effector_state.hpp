 ...
 * @return
 */
inline std::array<std::shared_ptr<EndEffectorState::Button>, 3> EndEffectorState::getButtonsStatus() const
{
 ...
 * @return
 */
inline uint32_t EndEffectorState::getAccelerometerXValue() const
{
 ...
 * @return
 */
inline uint32_t EndEffectorState::getAccelerometerYValue() const
{
 ...
 * @return
 */
inline uint32_t EndEffectorState::getAccelerometerZValue() const
{
 ...
 * @return
 */
inline bool EndEffectorState::getCollisionStatus() const
{
 ...
 * @return
 */
inline int EndEffectorState::getCollisionThresh() const
{
 ...
 * @return
 */
inline int EndEffectorState::getCollisionThreshAlgo2() const
{
 ...
 * @return
 */
inline bool EndEffectorState::getDigitalIn() const
{
  return _digital_in;
}
 ...
 * @return
 */
inline bool EndEffectorState::getDigitalOut() const
{
  return _digital_out;
}
