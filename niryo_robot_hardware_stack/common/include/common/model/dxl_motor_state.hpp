...
public:
  ...
  DxlMotorState(EHardwareType type, EComponentType component_type, uint8_t id);

  DxlMotorState(std::string name, EHardwareType type, EComponentType component_type, uint8_t id);
 ...
 * @return
 */
inline bool DxlMotorState::isTool() const
{
 ...
 * @return
 */
inline uint32_t DxlMotorState::getPositionPGain() const
{
  return _pos_p_gain;
}
 ...
 * @return
 */
inline uint32_t DxlMotorState::getPositionIGain() const
{
  return _pos_i_gain;
}
...
inline uint32_t DxlMotorState::getPositionDGain() const
{
  return _pos_d_gain;
}
 ...
 * @return
 */
inline uint32_t DxlMotorState::getVelocityPGain() const
{
  return _vel_p_gain;
}
 ...
 * @return
 */
inline uint32_t DxlMotorState::getVelocityIGain() const
{
  return _vel_i_gain;
}
 ...
 * @return
 */
inline uint32_t DxlMotorState::getFF1Gain() const
{
  return _ff1_gain;
}
 ...
 * @return
 */
inline uint32_t DxlMotorState::getFF2Gain() const
{
  return _ff2_gain;
}
 ...
 * @return
 */
inline uint32_t DxlMotorState::getVelProfile() const
{
  return _vel_profile;
}
 ...
 * @return
 */
inline uint32_t DxlMotorState::getAccProfile() const
{
  return _acc_profile;
}
 ...
 * @return
 */
inline double DxlMotorState::getStepsForOneSpeed() const
{
 ...
 * @return
 */
inline int DxlMotorState::getTotalRangePosition() const
{
 ...
 * @return
 */
inline double DxlMotorState::getTotalAngle() const
{
  return _total_angle;
}
