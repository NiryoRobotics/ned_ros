...
protected:
  AbstractEnum(E e = static_cast<E>(0)) : _enum(e)
  {
  }
 ...
 */
template <class C, typename E>
const std::string &AbstractEnum<C, E>::toString() const
{
 ...
 */
template <class C, typename E>
std::vector<std::string> AbstractEnum<C, E>::values(bool sort) const
{
  std::vector<std::string> values;
  for (typename std::map<E, std::string>::const_iterator iter = _map.begin(); iter != _map.end(); ++iter)
  {
