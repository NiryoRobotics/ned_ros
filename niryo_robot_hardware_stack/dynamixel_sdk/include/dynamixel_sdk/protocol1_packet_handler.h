...
public:
  ...
  /// @description when txpacket is called by Protocol1PacketHandler::broadcastPing() /
  /// Protocol1PacketHandler::syncWriteTxOnly() / Protocol1PacketHandler::regWriteTxOnly /
  ...
  /// @return or the other communication results which come from Protocol1PacketHandler::txPacket() and
  ...
  /// @return or the other communication results which come from Protocol1PacketHandler::txRxPacket() and
  ...
  /// @description transmits the packet with Protocol1PacketHandler::txRxPacket().
  /// @description To use this function, Dynamixel register should be set by Protocol1PacketHandler::regWriteTxOnly() or
  ...
  /// @description The function calls Protocol1PacketHandler::writeTxRx() for writing 1 byte data and receves the
  /// packet,
  /// @description gets the error from the packet.
  /// @param port PortHandler instance
  /// @param id Dynamixel ID
  ...
  /// @description The function calls Protocol1PacketHandler::writeTxRx() for writing 2 byte data and receves the
  /// packet,
  /// @description gets the error from the packet.
  /// @param port PortHandler instance
  /// @param id Dynamixel ID
  ...
  /// @description The function calls Protocol1PacketHandler::writeTxRx() for writing 4 byte data and receves the
  /// packet,
  /// @description gets the error from the packet.
  /// @param port PortHandler instance
  /// @param id Dynamixel ID
