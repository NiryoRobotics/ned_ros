...
public:
  ...
  /// @description The function activates only when the port is not busy and when the packet is already written on the
  /// port buffer
  ...
  ////////////////////////////////////////////////////////////////////////////////
  /// @brief The function that transmits packet (txpacket) and receives packet (rxpacket) during designated time via
  /// PortHandler port
  ...
  /// @description when txpacket is called by Protocol2PacketHandler::broadcastPing() /
  /// Protocol2PacketHandler::syncWriteTxOnly() / Protocol2PacketHandler::regWriteTxOnly /
  ...
  /// @return or the other communication results which come from Protocol2PacketHandler::txPacket() and
  ...
  /// @return or the other communication results which come from Protocol2PacketHandler::txRxPacket() and
  ...
  /// @description transmits the packet with Protocol2PacketHandler::txRxPacket().
  /// @description To use this function, Dynamixel register should be set by Protocol2PacketHandler::regWriteTxOnly() or
  ...
  /// @param port PortHandler instance
  /// @param id Dynamixel ID
  /// @param option Reset option (0xFF for reset all values / 0x01 for reset all values except ID / 0x02 for reset all
  /// values except ID and Baudrate)
  /// @param error Dynamixel hardware error
  /// @return communication results which come from Protocol2PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  ...
  /// @description The function receives the packet which might be come by previous INST_READ instruction packet
  /// transmission,
  ...
  /// @description The function calls Protocol2PacketHandler::writeTxRx() for writing 1 byte data and receves the
  /// packet,
  /// @description gets the error from the packet.
  /// @param port PortHandler instance
  /// @param id Dynamixel ID
  ...
  /// @description The function calls Protocol2PacketHandler::writeTxRx() for writing 2 byte data and receves the
  /// packet,
  /// @description gets the error from the packet.
  /// @param port PortHandler instance
  /// @param id Dynamixel ID
  ...
  /// @description The function calls Protocol2PacketHandler::writeTxRx() for writing 4 byte data and receves the
  /// packet,
  /// @description gets the error from the packet.
  /// @param port PortHandler instance
  /// @param id Dynamixel ID
  ...
  ////////////////////////////////////////////////////////////////////////////////
  /// @brief The function that transmits INST_REG_WRITE instruction packet with the data for writing on the Dynamixel
  /// register
  /// @description The function makes an instruction packet with INST_REG_WRITE and the data for writing on the
  /// Dynamixel register,
  /// @description transmits the packet with Protocol2PacketHandler::txPacket().
  /// @description The data written in the register will act when INST_ACTION instruction packet is transmitted to the
  /// Dynamixel.
  /// @param port PortHandler instance
  /// @param id Dynamixel ID
  /// @param address Address of the data for write
  ...
  ////////////////////////////////////////////////////////////////////////////////
  /// @brief The function that transmits INST_REG_WRITE instruction packet with the data for writing on the Dynamixel
  /// register, and receives the packet
  /// @description The function makes an instruction packet with INST_REG_WRITE and the data for writing on the
  /// Dynamixel register,
  /// @description transmits and receives the packet with Protocol2PacketHandler::txRxPacket(),
  /// @description gets the error from the packet.
  ...
  /// @return communication results which come from Protocol2PacketHandler::txPacket()
  ////////////////////////////////////////////////////////////////////////////////
  int syncReadTx(PortHandler *port, uint16_t start_address, uint16_t data_length, uint8_t *param,
  ...
  /// @param param Parameter for Sync Write {ID1, DATA0, DATA1, ..., DATAn, ID2, DATA0, DATA1, ..., DATAn, ID3, DATA0,
  /// DATA1, ..., DATAn}
  /// @param param_length Length of the data for Sync Write
  /// @return communication results which come from Protocol2PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  int syncWriteTxOnly(PortHandler *port, uint16_t start_address, uint16_t data_length, uint8_t *param,
                      uint16_t param_length);
  ...
  /// @description transmits the packet with Protocol2PacketHandler::txPacket().
  /// @param port PortHandler instance
  /// @param param Parameter for Bulk Read {ID1, ADDR_L1, ADDR_H1, LEN_L1, LEN_H1, ID2, ADDR_L2, ADDR_H2, LEN_L2,
  /// LEN_H2, ...}
  ...
  /// @description transmits the packet with Protocol2PacketHandler::txRxPacket().
  /// @param port PortHandler instance
  /// @param param Parameter for Bulk Write {ID1, START_ADDR_L, START_ADDR_H, DATA_LEN_L, DATA_LEN_H, DATA0, DATA1, ...,
  /// DATAn, ID2, START_ADDR_L, START_ADDR_H, DATA_LEN_L, DATA_LEN_H, DATA0, DATA1, ..., DATAn}
