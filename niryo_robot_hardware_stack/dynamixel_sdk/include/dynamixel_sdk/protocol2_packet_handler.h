...
class WINDECLSPEC Protocol2PacketHandler : public PacketHandler
{
  ...
  public:
    ...
    /// @description transmits the packet with Protocol2PacketHandler::txRxPacket().
    /// @param port PortHandler instance
    /// @param param Parameter for Bulk Write {ID1, START_ADDR_L, START_ADDR_H, DATA_LEN_L, DATA_LEN_H, DATA0, DATA1, ..., DATAn, ID2, START_ADDR_L, START_ADDR_H, DATA_LEN_L,
    /// DATA_LEN_H, DATA0, DATA1, ..., DATAn}
