...
void PortHandlerMac::setPortName(const char *port_name) { strcpy(port_name_, port_name); }
...
int PortHandlerMac::readPort(uint8_t *packet, int length) { return read(socket_fd_, packet, length); }

int PortHandlerMac::writePort(uint8_t *packet, int length) { return write(socket_fd_, packet, length); }
