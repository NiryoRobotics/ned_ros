...
private:
  ...
  common::model::EStepperCalibrationStatus _calibration_status{
    common::model::EStepperCalibrationStatus::UNINITIALIZED
  };
 ...
 * @return
 */
inline bool CanManager::isConnectionOk() const
{
 ...
 * @return
 */
inline size_t CanManager::getNbMotors() const
{
 ...
 * @return
 */
inline std::vector<uint8_t> CanManager::getRemovedMotorList() const
{
 ...
 * @return
 */
inline std::string CanManager::getErrorMessage() const
{
 ...
 * @return
 */
inline common::model::EStepperCalibrationStatus CanManager::getCalibrationStatus() const
{
 ...
 * @return
 */
inline void CanManager::setCalibrationStatus(const common::model::EStepperCalibrationStatus status)
{
