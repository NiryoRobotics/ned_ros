...
int CanDriver::setupCAN()
{
    ...
    _nh.getParam("/niryo_robot_hardware_interface/joints_driver/can_bus/spi_channel", spi_channel);
    _nh.getParam("/niryo_robot_hardware_interface/joints_driver/can_bus/spi_baudrate", spi_baudrate);
    _nh.getParam("/niryo_robot_hardware_interface/joints_driver/can_bus/gpio_can_interrupt", gpio_can_interrupt);
