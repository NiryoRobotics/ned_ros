...
TEST_F(ConveyorInterfaceTestSuiteAuto, controlConveyor1)
{
  ...
  auto subscriber = nh->subscribe<conveyor_interface::ConveyorFeedbackArray>(
      "/niryo_robot/conveyor/feedback", 1,
...
//************************
//    Two conveyor
// setTwoConveyor : set two conveyor, one after the other. WARNING : You need to wait for ROS_WARN message to manually
// connect a second conveyor
