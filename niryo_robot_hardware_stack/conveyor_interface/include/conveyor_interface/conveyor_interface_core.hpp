...
{
public:
  ConveyorInterfaceCore(ros::NodeHandle &nh, std::shared_ptr<ttl_driver::TtlInterfaceCore> ttl_interface,
...
private:
  struct BusConfig
  {
    ...
    bool isValid()
    {
      return !pool_id_list.empty() && type != common::model::EHardwareType::UNKNOWN;
    }
