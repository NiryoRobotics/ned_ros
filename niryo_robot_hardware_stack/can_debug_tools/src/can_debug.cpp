...
int handleUserInput(int argc, char **argv)
{
  try
  {
    ...
    description.add_options()("help,h", "Print help message")("channel,c", po::value<int>()->default_value(0),
                                                              "Spi Channel")(
        "baudrate,b", po::value<int>()->default_value(1000000),
        "Baud rate")("gpio,g", po::value<int>()->default_value(25), "gpio can interrupt")(
        "freq,f", po::value<double>()->default_value(100.0), "data check frequency in Hz (must be > 0)")("dump",
                                                                                                         "Dump any "
                                                                                                         "data from "
                                                                                                         "bus");
