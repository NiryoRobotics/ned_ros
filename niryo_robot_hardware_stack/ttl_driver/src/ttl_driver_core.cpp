...
void TtlDriverCore::initParameters(ros::NodeHandle& nh)
{
    ...
    _nh.getParam("/niryo_robot_hardware_interface/motors_driver/dxl_hardware_control_loop_frequency",
                 _control_loop_frequency);

    _nh.getParam("/niryo_robot_hardware_interface/motors_driver/dxl_hardware_write_frequency",
                 write_frequency);

    _nh.getParam("/niryo_robot_hardware_interface/motors_driver/dxl_hardware_read_data_frequency",
                 read_data_frequency);

    _nh.getParam("/niryo_robot_hardware_interface/motors_driver/dxl_hardware_read_status_frequency",
