...
namespace ttl_driver
{
     ...
     * @return
     */
    inline common::model::EStepperCalibrationStatus
                                                  ...
                                                  ttl_driver::WritePIDValue::Response &res)
    {
        ...
        auto dxl_cmd_pos_p = std::make_unique<DxlSingleCmd>(EDxlCommandType::CMD_TYPE_PID,
                                                            req.id, std::initializer_list<uint32_t>{req.pos_p_gain, req.pos_i_gain, req.pos_d_gain, req.vel_p_gain, req.vel_i_gain, req.ff1_gain, req.ff2_gain, req.vel_profile, req.acc_profile});
                                                         ...
                                                         ttl_driver::WriteVelocityProfile::Response &res)
    {
        ...
        auto profile_cmd = std::make_unique<StepperTtlSingleCmd>(EStepperCommandType::CMD_TYPE_VELOCITY_PROFILE,
                                                                 req.id, std::initializer_list<uint32_t>{v_start, a_1, v_1, a_max, v_max, d_max, d_1, v_stop});
