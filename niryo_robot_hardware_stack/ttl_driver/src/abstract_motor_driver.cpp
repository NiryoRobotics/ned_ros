...
namespace TTLDriver
{
     ...
     * @return
     */
    int AbstractMotorDriver::syncRead(uint8_t address, uint8_t data_len, const vector<uint8_t> &id_list, vector<uint32_t> &data_list)
    {
        data_list.clear();
     ...
     * @return
     */
    int AbstractMotorDriver::syncWrite(uint8_t address, uint8_t data_len, const std::vector<uint8_t> &id_list, const std::vector<uint32_t> &data_list)
    {
