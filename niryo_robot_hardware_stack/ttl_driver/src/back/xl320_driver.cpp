...
#include "ttl_driver/xl320_driver.hpp"
#include "model/motor_type_enum.hpp"

#include "ttl_driver/xl320_reg.hpp"
...
namespace DynamixelDriver
{
    ...
    {
       return "Driver - type: XL320" + TTLMotorDriver::str();
    }
    ...
    {
        return write(XL320Reg::ADDR_STATUS_RETURN_LEVEL, XL320Reg::SIZE_STATUS_RETURN_LEVEL, id, return_level);
    }
    ...
    {
        return read(XL320Reg::ADDR_PRESENT_VELOCITY, XL320Reg::SIZE_PRESENT_VELOCITY, id, present_velocity);
    }
    ...
    {
        return read(XL320Reg::ADDR_STATUS_RETURN_LEVEL, XL320Reg::SIZE_STATUS_RETURN_LEVEL, id, return_level);
    }
    ...
    {
        return syncRead(XL320Reg::ADDR_PRESENT_VELOCITY, XL320Reg::SIZE_PRESENT_VELOCITY, id_list, velocity_list);
    }
