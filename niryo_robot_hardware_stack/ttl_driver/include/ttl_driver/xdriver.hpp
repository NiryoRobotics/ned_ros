...
public:
    ...
    virtual int setVelocityPGain(uint8_t id, uint32_t gain ) override{ std::cout << "not implemented" << std::endl; return 0; }
    virtual int setVelocityIGain(uint8_t id, uint32_t gain ) override{ std::cout << "not implemented" << std::endl; return 0; }
