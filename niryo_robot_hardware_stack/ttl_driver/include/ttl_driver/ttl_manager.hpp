...
public:
  ...
  int readMotorPID(uint8_t id, uint16_t &pos_p_gain, uint16_t &pos_i_gain, uint16_t &pos_d_gain, uint16_t &vel_p_gain,
                   uint16_t &vel_i_gain, uint16_t &ff1_gain, uint16_t &ff2_gain);

  int readVelocityProfile(uint8_t id, uint32_t &v_start, uint32_t &a_1, uint32_t &v_1, uint32_t &a_max, uint32_t &v_max,
                          uint32_t &d_max, uint32_t &d_1, uint32_t &v_stop);
 ...
 * @return
 */
inline bool TtlManager::isConnectionOk() const
{
 ...
 * @return
 */
inline size_t TtlManager::getNbMotors() const
{
 ...
 * @return
 */
inline std::vector<uint8_t> TtlManager::getRemovedMotorList() const
{
 ...
 * @return
 */
inline std::string TtlManager::getErrorMessage() const
{
 ...
 * @return
 */
inline common::model::EStepperCalibrationStatus TtlManager::getCalibrationStatus() const
{
 ...
 * @return
 */
inline bool TtlManager::needCalibration() const
{
 ...
 * @return
 */
inline bool TtlManager::isCalibrationInProgress() const
{
 ...
 * @return
 */
inline bool TtlManager::hasEndEffector() const
{
 ...
 * @return
 */
inline bool TtlManager::getCollisionStatus() const
{
