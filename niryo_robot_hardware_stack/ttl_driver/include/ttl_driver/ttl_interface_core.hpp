...
private:
  ...
  bool _callbackWriteCustomValue(ttl_driver::WriteCustomValue::Request &req,
  ...
  bool _callbackWriteVelocityProfile(ttl_driver::WriteVelocityProfile::Request &req,
                                     ttl_driver::WriteVelocityProfile::Response &res);
  bool _callbackReadVelocityProfile(ttl_driver::ReadVelocityProfile::Request &req,
 ...
 * @return
 */
inline common::model::EBusProtocol TtlInterfaceCore::getBusProtocol() const
{
