...
struct XL330Reg
{
    static constexpr common::model::EMotorType motor_type = common::model::EMotorType::XL330;
    ...
    static constexpr std::uint8_t ADDR_CURRENT_LIMIT            = 38;
    static constexpr std::uint8_t SIZE_CURRENT_LIMIT            = 2;
    ...
    static constexpr std::uint8_t ADDR_GOAL_CURRENT             = 102;
    static constexpr std::uint8_t SIZE_GOAL_CURRENT             = 2;
    ...
    static constexpr std::uint8_t ADDR_PRESENT_CURRENT          = 126;
    static constexpr std::uint8_t SIZE_PRESENT_CURRENT          = 2;
