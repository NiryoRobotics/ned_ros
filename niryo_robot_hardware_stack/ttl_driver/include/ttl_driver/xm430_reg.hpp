...
#ifndef XM430_REG_HPP
#define XM430_REG_HPP
...
struct XM430Reg
{
    static constexpr common::model::EHardwareType motor_type = common::model::EHardwareType::XM430;

    static constexpr float PROTOCOL_VERSION                     = 2.0;
    static constexpr int MODEL_NUMBER                           = 1020;
