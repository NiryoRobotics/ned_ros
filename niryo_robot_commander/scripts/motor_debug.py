...
class MotorDebug:
    def __init__(self):
        ...
        self.__commander_log_level_service_name = "/niryo_robot_commander/set_logger_level"
    ...
    def __play_fun_poses(self):
        error_cpt = 0
        waypoints = [[1.3, -0.8, -1, -1.3, 0.7, -2], [0.2, 0.3, -0.2, -0.2, -1, 0], [-1.7, -0.8, -0.8, 0.9, 0.9, 1.6],
                     [0, 0.6, 0, 0, 0.8, 0]]
