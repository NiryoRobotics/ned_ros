...
from .old.enums import ColorRequest, ShapeRequest  # Shape and color used from modbus client
...
# Services
from conveyor_interface.srv import SetConveyorRequest
...
class HoldingRegisterDataBlock(DataBlock):
    """
    Holding Register: Read / Write 16-bit datas
    """
    ...
    def __init__(self, ros_wrapper):
        ...
        # python_ros_wrapper
        self.python_ros_wrapper = ros_wrapper
