...
cp ./niryo_robot_tools/config/end_effectors_v1.yaml ./niryo_robot_tools/config/end_effectors.yaml
cp ./niryo_robot_hardware_stack/stepper_driver/config/default_v1.yaml ./niryo_robot_hardware_stack/stepper_driver/config/default.yaml
...
cp ./niryo_robot_hardware_stack/dynamixel_driver/config/motors_config_v1.yaml ./niryo_robot_hardware_stack/dynamixel_driver/config/motors_config.yaml
cp ./niryo_robot_hardware_stack/dynamixel_driver/config/default_v1.yaml ./niryo_robot_hardware_stack/dynamixel_driver/config/default.yaml
