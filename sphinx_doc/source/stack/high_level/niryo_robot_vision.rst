...
.. list-table:: Vision Package's Publishers
   ...
   *  -  ``video_stream_parameters``
      -  :ref:`ImageParameters<source/stack/high_level/niryo_robot_vision:ImageParameters (Topic)>`
...
.. list-table:: Programs manager Services
   ...
   *  -  Name
      ...
      -  Description
   *  -  ``debug_colors``
      -  :ref:`DebugColorDetection<source/stack/high_level/niryo_robot_vision:DebugColorDetection (Service)>`
      -  Returns an annotated image to emphasize what happened with color detection
   *  -  ``debug_markers``
      -  :ref:`DebugMarkers<source/stack/high_level/niryo_robot_vision:DebugMarkers (Service)>`
      -  Returns an annotated image to emphasize what happened with markers detection
   *  -  ``obj_detection_rel``
      -  :ref:`ObjDetection<source/stack/high_level/niryo_robot_vision:ObjDetection (Service)>`
      -  Object detection service
   *  -  ``start_stop_video_streaming``
      -  :ref:`source/stack/high_level/niryo_robot_msgs:SetBool`
      -  Starts or stops video streaming
   *  -  ``take_picture``
      -  :ref:`TakePicture<source/stack/high_level/niryo_robot_vision:TakePicture (Service)>`
