...
class ArmCommander:
    ...
    def set_pose_target_from_cmd(self, arm_cmd):
        ...
        :return: status, message
        """
        self.__validate_params_move(ArmMoveCommand.POSE, arm_cmd.position, arm_cmd.rpy)
    ...
    def set_position_target(self, arm_cmd):
        ...
        :return: status, message
        """
        self.__validate_params_move(ArmMoveCommand.POSITION, arm_cmd.position)
        x, y, z = arm_cmd.position.x, arm_cmd.position.y, arm_cmd.position.z
    ...
    def set_rpy_target(self, arm_cmd):
        ...
        :return: status, message
        """
        self.__validate_params_move(ArmMoveCommand.RPY, arm_cmd.rpy)
        roll, pitch, yaw = arm_cmd.rpy.roll, arm_cmd.rpy.pitch, arm_cmd.rpy.yaw
    ...
    def set_pose_quat_target(self, arm_cmd):
        ...
        :return: status, message
        """
        self.__validate_params_move(ArmMoveCommand.POSE_QUAT, arm_cmd.position, arm_cmd.orientation)
        x, y, z = arm_cmd.position.x, arm_cmd.position.y, arm_cmd.position.z
